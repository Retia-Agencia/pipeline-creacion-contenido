...
| [plan-modo-seleccion.md](./plan-modo-seleccion.md) | 291 | ✅ Construido (fases 0, 1, 2, 3, 4 y 6), aunque su encabezado siguiera diciendo *"acordado, sin construir"*. Su decisión de fondo es [ADR-075](../adr/ADR-075-agrupar-es-aprobar.md); lo que le quedaba abierto —2 verificaciones humanas y 5 canarios vencidos— se mudó a [verificaciones-humanas.md](../verificaciones-humanas.md) §18-§20, que es su dueño |
